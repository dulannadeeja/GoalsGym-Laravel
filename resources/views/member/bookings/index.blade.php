    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <ul class="space-y-6 mb-8">
                @forelse($allBookedClasses as $class)
                            ...
                            <div class="basis-2/3">
                                ...
                                <div class="flex gap-5 items-center">
                                    <p class="text-lg"><span
                                            class="text-2xl font-semibold text-amber-600">Conducted by:</span> {{$class->instructor->name}}
                                    </p>
                                    <p class="text-lg"><span
                ...
                @empty
                    <div
                        ...
                        {{ __("Currently don't have any upcoming scheduled classes!") }}
                    </div>
                @endforelse
            </ul>
            {{ $allBookedClasses->links() }}
        </div>
    </div>
</x-app-layout>
